...
class ScoreRulesTest extends RulesTestCase
{
    ...
    public static function scores(): array
    {
        return [
            ...
            [9, [], ['AGILE_VALUE_HUMOR', 'AGILE_VALUE_FEEDBACK', 'AGILE_VALUE_TRUST'], []],
            [16, [], ['AGILE_VALUE_HUMOR', 'AGILE_VALUE_FEEDBACK', 'AGILE_VALUE_TRUST', 'AGILE_VALUE_COURAGE'], []],
            ...
            [16,
                ...
                ['AGILE_MATURITY_USER_EXPERIENCE', 'AGILE_VALUE_HUMOR', 'AGILE_VALUE_FEEDBACK', 'AGILE_VALUE_TRUST'], []
            ],
            [20,
                ['PRODUCT_TEAM_SOCIAL', 'PRODUCT_TEAM_MMOG', 'PRODUCT_TEAM_MMOG'],
                ['AGILE_MATURITY_PRODUCT_VISION', 'AGILE_MATURITY_USER_EXPERIENCE', 'AGILE_VALUE_HUMOR', 'AGILE_VALUE_FEEDBACK', 'AGILE_VALUE_TRUST'], []
            ],
            [17,
                ['PRODUCT_TEAM_SOCIAL', 'PRODUCT_TEAM_MMOG'],
                ['AGILE_MATURITY_AGILE_SENSEI', 'AGILE_VALUE_HUMOR', 'AGILE_VALUE_FEEDBACK', 'AGILE_VALUE_TRUST'], []
            ],
            [23,
                ['PRODUCT_TEAM_SOCIAL', 'PRODUCT_TEAM_MMOG'],
                ['AGILE_MATURITY_AGILE_SENSEI', 'AGILE_MATURITY_PRODUCT_VISION', 'AGILE_VALUE_HUMOR', 'AGILE_VALUE_FEEDBACK', 'AGILE_VALUE_TRUST'], []
            ],
